...
from middleware.exception_handlers import general_exception_handler
...
def get_application() -> FastAPI:
    ...
    application.add_middleware(ExceptionMiddleware,handlers={Exception: general_exception_handler})
